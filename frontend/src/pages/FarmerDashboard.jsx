...
export default function FarmerDashboard({ setCurrentPage }) {
  const { user } = useAuth();
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="px-8 py-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <button
              onClick={() => setCurrentPage && setCurrentPage('register-farm')}
            ...
            <Card variant="default">
              ...
              <div className="space-y-3">
                <div className="flex gap-3">
                  <div className="h-6 w-6 rounded-full bg-slate-900 flex items-center justify-center flex-shrink-0">
